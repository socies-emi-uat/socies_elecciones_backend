...
public class AuthController {
    ...
    @PostMapping("/login")
    public ResponseEntity<ResponseWrapper<LoginAuthResponseDTO>> login(@RequestBody LoginAuthDTO loginAuthDTO) {
        LoginAuthResponseDTO loginAuthResponseDTO = authService.verify(loginAuthDTO);
        ResponseWrapper<LoginAuthResponseDTO> response = new ResponseWrapper<>(true, "Inicio de sesion correcto.", loginAuthResponseDTO);

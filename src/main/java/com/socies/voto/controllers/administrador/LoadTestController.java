...
public class LoadTestController {
    ...
    @Operation(
            summary = "Ejecutar prueba de carga",
    ...
    @Operation(
            summary = "Ejecutar prueba de estrés",
    ...
    @Operation(
            summary = "Obtener resultados por día",
    ...
    @Operation(
            summary = "Obtener resumen diario",
    ...
    public ResponseEntity<DailyTestSummaryDTO> getDailySummary(
            @Parameter(description = "Fecha en formato YYYY-MM-DD")
                    ...
                    @DateTimeFormat(iso = DateTimeFormat.ISO.DATE)
                    LocalDate date,
            @Parameter(description = "Tipo de prueba: LOAD o STRESS") @RequestParam
                    String testType) {
    ...
    @Operation(
            summary = "Obtener resultados por rango de fechas",
    ...
    public ResponseEntity<List<DailyTestSummaryDTO>> getResultsByDateRange(
        ...
        List<DailyTestSummaryDTO> summaries =
                loadTestService.getResultsByDateRange(startDate, endDate, testType);
        return ResponseEntity.ok(summaries);
    }

    @GetMapping("/endpoints/test")
    @Operation(
            summary = "Obtener endpoints disponibles para testing",

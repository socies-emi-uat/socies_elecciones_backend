...
public class UsuarioController {
    ...
    public ResponseEntity<ResponseWrapper<List<UsuarioDTO>>> getAllUsers() {
        ...
        ResponseWrapper<List<UsuarioDTO>> response =
                new ResponseWrapper<>(true, "Usuarios obtenidos correctamente.", usuarios);
        return new ResponseEntity<>(response, HttpStatus.OK);
    }

    // Crear un usuario
    @PostMapping
    public ResponseEntity<ResponseWrapper<UsuarioDTO>> createUser(
        ...
        ResponseWrapper<UsuarioDTO> response =
                new ResponseWrapper<>(true, "Usuario creado exitosamente.", usuario);
    ...
    public ResponseEntity<ResponseWrapper<UsuarioDTO>> getUserById(@PathVariable Long id_usuario) {
        ...
        ResponseWrapper<UsuarioDTO> response =
                new ResponseWrapper<>(true, "Usuario encontrado.", usuario);
        return new ResponseEntity<>(response, HttpStatus.OK);
    }
    ...
    */
    ...
    public ResponseEntity<ResponseWrapper<UsuarioDTO>> disableOrEnableUser(
            @PathVariable Long id_usuario) {
        String estado_usuario = usuarioService.disableOrEnableUser(id_usuario);
        ResponseWrapper<UsuarioDTO> response =
                new ResponseWrapper<>(true, "Usuario " + estado_usuario, null);
        return new ResponseEntity<>(response, HttpStatus.OK);
    }
}

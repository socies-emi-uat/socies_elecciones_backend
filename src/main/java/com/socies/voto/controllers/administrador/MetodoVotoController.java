...
public class MetodoVotoController {
    ...
    @Autowired
    private MetodoVotoService metodoVotoService;
    ...
    public ResponseEntity<ResponseWrapper<List<MetodoVotoDTO>>> getAllMetodosVoto() {
        ...
        ResponseWrapper<List<MetodoVotoDTO>> response = new ResponseWrapper<>(
    ...
    public ResponseEntity<ResponseWrapper<MetodoVotoDTO>> createMetodoVoto(
        ...
        ResponseWrapper<MetodoVotoDTO> response = new ResponseWrapper<>(
                true, "Método de voto creado exitosamente.", metodoVoto);
    ...
    @GetMapping("/{id}")
    public ResponseEntity<ResponseWrapper<MetodoVotoDTO>> getMetodoVotoById(
            @PathVariable Long id) {
        MetodoVotoDTO metodoVoto = metodoVotoService.findById(id);
        ResponseWrapper<MetodoVotoDTO> response = new ResponseWrapper<>(
                true, "Método de voto encontrado.", metodoVoto);
        return new ResponseEntity<>(response, HttpStatus.OK);
    }
    ...
    public ResponseEntity<ResponseWrapper<MetodoVotoGetVotosDTO>> getMetodoVotoWithVotos(
        ...
        ResponseWrapper<MetodoVotoGetVotosDTO> response = new ResponseWrapper<>(
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<ResponseWrapper<String>> deleteMetodoVoto(
            @PathVariable Long id) {
        metodoVotoService.delete(id);
        ResponseWrapper<String> response = new ResponseWrapper<>(
            true, "Método de voto eliminado exitosamente.", "OK");
        return new ResponseEntity<>(response, HttpStatus.OK);
    }
}
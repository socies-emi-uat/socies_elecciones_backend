...
public class DepartamentoController {
    ...
    public ResponseEntity<ResponseWrapper<List<DepartamentoDTO>>> findAll() {
        ...
        ResponseWrapper<List<DepartamentoDTO>> departamentos = new ResponseWrapper<>(true, "Todos los departamentos.", departamentosDTO);
    ...
    public ResponseEntity<ResponseWrapper<DepartamentoDTO>> findById(@PathVariable Long id) {
        ...
        ResponseWrapper<DepartamentoDTO> departamento = new ResponseWrapper<>(true, "Departamento encontrado.", departamentoDTO);
        return new ResponseEntity<>(departamento, HttpStatus.OK);
    }

    @PostMapping
    public ResponseEntity<ResponseWrapper<DepartamentoDTO>> crearDepartamento(@Valid @RequestBody DepartamentoCreateDTO departamentoCreateDTO) {
    ...
    public ResponseEntity<ResponseWrapper<DepartamentoDTO>> actualizar(@PathVariable Long id, @Valid @RequestBody DepartamentoUpdateDTO departamentoUpdateDTO) {
